...
public class remove_employee implements ActionListener{
    ...
    remove_employee(){
        ...
        l5.setLayout(null);
        ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("employeeproject/Icons/remove_page.jpg"));
      //  id15.setIcon(img);
     ...
     /*   l5=new JLabel();
        l5.setBounds(0,0,500,500);
        l5.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("employeeproject/icons/remove.jpg"));
        l5.setIcon(img);
        f.add(l5);*/
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String q = "SELECT Name,Phone,Email_Id from employee where Emp_id ='"+t.getText()+"' ";
